...
class Joystick(open_duck_mini_v2_base.OpenDuckMiniV2Env):
    ...
    def step(self, state: mjx_env.State, action: jax.Array) -> mjx_env.State:
        ...
        reward_floor = self._config.reward_config.get("reward_floor", 0.0)
        reward = jp.clip(
    ...
    def _get_obs(
        ...
        # JAX arrays are immutable: keep the returned array so training sees the
        # same accelerometer calibration offset as native MuJoCo inference.
