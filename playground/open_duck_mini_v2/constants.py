...
# Recovery needs a torso collision shell; the upstream model only collides with
# the foot soles.  This variant is generated by make_getup_model.py and leaves
# the original flat-terrain assets untouched.
FLAT_TERRAIN_GETUP_XML = ROOT_PATH / "xmls" / "scene_flat_terrain_getup.xml"
...
def task_to_xml(task_name: str) -> epath.Path:
    return {
        ...
        "flat_terrain_getup": FLAT_TERRAIN_GETUP_XML,
    }[task_name]
