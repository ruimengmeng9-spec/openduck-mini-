...
DEFAULT_OUTPUT = Path("/data/shijinsheng/open_duck/outputs/backward_v18_validation_20260918")
...
CANDIDATES = {
    ...
    "v18_imit8p0": Path(
        "/data/shijinsheng/open_duck/training/backward_v18_imit8p0/final.onnx"
    ),
    "v18_imit20p0": Path(
