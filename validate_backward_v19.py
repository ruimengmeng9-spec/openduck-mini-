...
DEFAULT_OUTPUT = Path("/data/shijinsheng/open_duck/outputs/backward_v19_validation_20260918")
...
CANDIDATES = {
    ...
    "v18_imit20p0": Path(
        "/data/shijinsheng/open_duck/training/backward_v18_imit20p0/final.onnx"
    ),
    "v19_pure_imit8": Path(
        "/data/shijinsheng/open_duck/training/backward_v19_pure_imit8/final.onnx"
    ),
    "v19_pure_imit20": Path(
        "/data/shijinsheng/open_duck/training/backward_v19_pure_imit20/final.onnx"
    ),
}
