...
DEFAULT_OUTPUT = Path("/data/shijinsheng/open_duck/outputs/backward_v17_validation_20260918")

CANDIDATES = {
    "v12_best_reverse": Path(
        "/data/shijinsheng/open_duck/training/backward_v12_ratio_curriculum_20260915/final.onnx"
    ),
    "v15_fixed_unstable": Path(
        "/data/shijinsheng/open_duck/training/backward_v15_from_v12/final.onnx"
    ),
    "v16_stable": Path(
        "/data/shijinsheng/open_duck/training/backward_v16_stable/final.onnx"
    ),
    "v17_grid_imit05": Path(
        "/data/shijinsheng/open_duck/training/backward_v17_grid_imit05/final.onnx"
    ),
    "v17_grid_imit10": Path(
        "/data/shijinsheng/open_duck/training/backward_v17_grid_imit10/final.onnx"
    ),
}
...
def main() -> None:
    ...
    parser.add_argument("--speeds", type=float, nargs="+", default=[-0.04, -0.06, -0.074])
