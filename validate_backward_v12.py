...
TRAINING = Path("/data/shijinsheng/open_duck/training/backward_v12_ratio_curriculum_20260915")
OUTPUT = Path("/data/shijinsheng/open_duck/outputs/backward_v12_validation_20260915")

CANDIDATES = {
    "v12_8p52m": TRAINING / "step_8519680.onnx",
    "v12_10p65m": TRAINING / "step_10649600.onnx",
    "v12_12p78m": TRAINING / "final.onnx",
}
